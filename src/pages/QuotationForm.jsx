...
const QuotationForm = () => {
    ...
    const { id } = useParams(); // For edit mode (not fully implemented in this step)
    ...
    const [terms, setTerms] = useState('1. Delivery within 7 days.\n2. Payment 100% advance.\n3. Taxes as applicable.');
    ...
    const handleItemChange = (index, field, value) => {
        ...
        if (field === 'item_id') {
            ...
            if (product) {
                ...
                newItems[index].amount = product.unit_price * newItems[index].quantity; // Default quantity 1
            }
        }
